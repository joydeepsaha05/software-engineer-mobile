...
public class FlickrHelper {
    ...
    public static final String FLICKR_DATE_PATTERN = "yyyy-MM-dd";
    private static final SimpleDateFormat FLICKR_DATE_FORMAT = new SimpleDateFormat(FLICKR_DATE_PATTERN);
    ...
    public static GsonBuilder getGsonBuilder() {
        ...
        builder.registerTypeAdapter(Date.class, new JsonDeserializer<Date>() {
            ...
            public Date deserialize(JsonElement json, Type typeOfT,
                ...
                try {
                    return FLICKR_DATE_FORMAT.parse(json.getAsString());
